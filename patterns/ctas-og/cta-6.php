<?php
/**
 * Description: Image with overlapped content CTA section
...
<div class="wp-block-group alignfull has-alt-background-color has-background"><!-- wp:acf/mai-columns {"name":"acf/mai-columns","data":{"mai_columns_columns":"2","mai_columns_align_columns":"start","mai_columns_align_columns_vertical":"middle","mai_columns_column_gap":"","mai_columns_row_gap":"","mai_columns_margin_top":"","mai_columns_margin_bottom":""},"mode":"preview"} -->
...
<!-- wp:image {"id":1931,"sizeSlug":"square-lg","linkDestination":"none"} -->
<figure class="wp-block-image size-square-lg"><img src="<?php echo maidp_get_image_url( 'placeholder-square' ); ?>" alt="placeholder image"/></figure>
<!-- /wp:image -->
<!-- /wp:acf/mai-column -->

<!-- wp:acf/mai-column {"name":"acf/mai-column","data":{"mai_column_align_column_vertical":"start","mai_column_spacing":"","mai_column_background":"","mai_columns_shadow":"0","mai_columns_border":"0","mai_columns_radius":"0","mai_columns_first_xs":"0","mai_columns_first_sm":"0","mai_columns_first_md":"0"},"mode":"preview"} -->
