 ...
 */
?>
<!-- wp:group {"align":"full","backgroundColor":"alt","contentWidth":"xl","verticalSpacingTop":"sm","verticalSpacingBottom":"sm"} -->
...
<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, est quas epicurei cu. Ei pri quot pertinax. Ad suas argumentum mel, in mel esse illud erroribus.</p>
<!-- /wp:paragraph -->
<!-- /wp:acf/mai-column -->
