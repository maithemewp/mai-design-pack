 ...
 * Keywords: image, cta, section
 */
?>

<!-- wp:group {"align":"full","contentWidth":"xl","verticalSpacingTop":"md","verticalSpacingBottom":"md"} -->
<div class="wp-block-group alignfull"><!-- wp:acf/mai-columns {"name":"acf/mai-columns","data":{"columns":"2","_columns":"mai_columns_columns","align_columns":"start","_align_columns":"mai_columns_align_columns","align_columns_vertical":"middle","_align_columns_vertical":"mai_columns_align_columns_vertical","column_gap":"xxl","_column_gap":"mai_columns_column_gap","row_gap":"xxl","_row_gap":"mai_columns_row_gap","margin_top":"","_margin_top":"mai_columns_margin_top","margin_bottom":"","_margin_bottom":"mai_columns_margin_bottom"},"mode":"preview"} -->
...
<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, est quas epicurei cu. Ei pri quot pertinax. Ad suas argumentum mel, in mel esse illud erroribus. Dicat minimum eu per, eum fugit periculis et. Suas minim inimicus pri te, ea audire detraxit convenire eam. Ius ne antiopam platonem.</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-large"><img src="<?php echo maidp_get_placeholder_image_url( 'landscape' ); ?>" alt="placeholder image"/></figure>
<!-- /wp:image -->
<!-- /wp:acf/mai-column -->
