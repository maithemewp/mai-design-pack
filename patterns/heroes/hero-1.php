 ...
 */
?>
<!-- wp:cover {"url":"<?php echo maidp_get_placeholder_image_url( 'landscape' ); ?>","dimRatio":90,"overlayColor":"heading","align":"full","contentWidth":"md","verticalSpacingTop":"lg","verticalSpacingBottom":"lg"} -->
<div class="wp-block-cover alignfull"><span aria-hidden="true" class="wp-block-cover__background has-heading-background-color has-background-dim-90 has-background-dim"></span><img class="wp-block-cover__image-background" alt="placeholder image" src="<?php echo maidp_get_placeholder_image_url( 'landscape' ); ?>" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center"} -->
